...
<Figure
  ...
  alt="OpenTelemetry key features: multi-language support, extensibility, standardized data formats, and vendor-agnostic architecture."
  caption="OpenTelemetry key features: multi-language support, extensibility, standardized data formats, and vendor-agnostic architecture."
/>
...
<Figure
  src="/img/comparisons/2024/10/opentelemetry-vs-cloudwatch-napkin-selection_(12).webp"
  alt="CloudWatch key features: real-time metrics, pre-built dashboards, log aggregation, and alerts/notifications."
  caption="CloudWatch key features: real-time metrics, pre-built dashboards, log aggregation, and alerts/notifications."
/>
