...
<Figure
  src="/img/comparisons/2024/10/opentelemetry-vs-azure-monitor-image.webp"
  alt="Key Features of OpenTelemetry"
  caption="Key Features of OpenTelemetry"
/>
...
<Figure
  src="/img/comparisons/2024/10/opentelemetry-vs-azure-monitor-image%201.webp"
  alt="Key Features of Azure Monitor"
  caption="Key Features of Azure Monitor"
/>
...
3. Configure Application Insights Connection:
   ...
   - Retrieve the Connection String:
     ...
     - Copy the connection string from the Overview tab.
       <Figure
         src="/img/comparisons/2024/10/opentelemetry-vs-azure-monitor-migrate-from-instrumentation-keys-to-connection-strings.webp"
         alt="Application Insights resource - Connection String (credits - Microsoft Azure)"
         caption="Application Insights resource - Connection String (credits - Microsoft Azure)"
       />
...
4. Confirm Data Flow:
   ...
   <Figure
     src="/img/comparisons/2024/10/opentelemetry-vs-azure-monitor-004d06bc-3041-4dac-b53e-20200b81b0fc.webp"
     alt="Application monitoring with Azure OpenTelemetry Distro in Azure Monitor resource - (credits - Microsoft Azure)"
     caption="Application monitoring with Azure OpenTelemetry Distro in Azure Monitor resource - (credits - Microsoft Azure)"
   />
