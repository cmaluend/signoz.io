...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-vs-aws-xray-image.webp"
  alt="Diagram of X-Ray architecture and its components"
  caption="Diagram of X-Ray architecture and its components"
/>
