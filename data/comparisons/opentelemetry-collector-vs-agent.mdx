...
keywords:
  [opentelemetry collector vs agent, observability, telemetry data, monitoring, data collection]
---
...
<Figure
  src="/img/comparisons/2024/10/otel-collector-architecture_(1).svg"
  alt="How the OpenTelemetry Collector works"
  caption="How the OpenTelemetry Collector works"
/>
