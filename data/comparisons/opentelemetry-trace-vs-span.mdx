...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-Untitled.webp"
...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image.webp"
  alt="Visualizing Request Flows"
  caption="Visualizing Request Flows"
/>
...
3. Trace Propagation: The mechanism by which trace context is passed between different services or components. This ensures that all parts of a distributed operation are connected under the same trace.
   ...
   <Figure
     src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image%201.webp"
     alt="Trace Propagation Flow"
     caption="Trace Propagation Flow"
   />
...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image%202.webp"
  alt="Trace in a Microservice environment"
  caption="Trace in a Microservice environment"
/>
...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image%203.webp"
...
<Figure
  src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image%204.webp"
  alt="SigNoz Trace Dashboard"
  caption="SigNoz Trace Dashboard"
/>
