...
<Figure src="/img/comparisons/2025/10/signoz-overview.webp" alt="SigNoz observability platform dashboard" caption="SigNoz dashboard" />
...
<Figure src="/img/comparisons/2025/10/datadog-overview.webp" alt="Datadog observability platform dashboard" caption="Datadog dashboard (credits: Datadog)" />
...
<Figure src="/img/comparisons/2025/10/newrelic-overview.webp" alt="New Relic observability platform dashboard" caption="New Relic dashboard (credits: New Relic)" />
...
<Figure src="/img/comparisons/2025/10/honeycomb-overview.webp" alt="Honeycomb observability platform dashboard" caption="Honeycomb dashboard (credits: Honeycomb)" />
...
<Figure src="/img/comparisons/2025/10/grafana-overview.webp" alt="Grafana observability platform dashboard" caption="Grafana dashboard (credits: Grafana)" />
...
<Figure src="/img/comparisons/2025/10/jaeger-overview.webp" alt="Jaeger distributed tracing dashboard" caption="Jaeger dashboard" />
...
<Figure src="/img/comparisons/2025/10/elastic-overview.webp" alt="Elastic Observability platform dashboard" caption="Elastic Observability dashboard (credits: Elastic)" />
...
<Figure src="/img/comparisons/2025/10/splunk-overview.webp" alt="Splunk Observability Cloud platform dashboard" caption="Splunk Observability Cloud dashboard (credits: Splunk)" />
...
<Figure src="/img/comparisons/2025/10/dynatrace-overview.webp" alt="Dynatrace observability platform dashboard" caption="Dynatrace dashboard (credits: Dynatrace)" />
