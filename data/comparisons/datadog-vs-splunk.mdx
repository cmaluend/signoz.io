...
<figure data-zoomable align="center">
  <img className="box-shadowed-image" src="/img/blog/2024/03/datadog-vs-splunk-flamegraphs.webp" alt="Visualization of [traces and spans](https://signoz.io/comparisons/opentelemetry-trace-vs-span/) using flamegraphs in Datadog" />
  <figcaption>
