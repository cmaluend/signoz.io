...
<Figure  src="/img/comparisons/2025/10/chronosphere-vs-datadog-datadog-architecture.webp" alt="Datadog tracing dashboard" caption="Datadog's tracing dashboard (credits: Datadog)" />
...
<Figure src="/img/comparisons/2025/10/chronosphere-vs-datadog-chronosphere-architecture.webp" alt="Chronosphere's Trace Control Plane" caption="Chronosphere's Trace Control Plane (credits: Chronosphere)" />
