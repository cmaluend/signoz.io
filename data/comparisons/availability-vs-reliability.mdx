...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image.webp"
  alt="Availability vs Fault tolerance"
  caption="Availability vs Fault tolerance"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%201.webp"
  alt="Steps for calculating downtime per year for five nines"
  caption="Steps for calculating downtime per year for five nines"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%202.webp"
  alt="Common Availability Targets"
  caption="Common Availability Targets"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%203.webp"
  alt="Real world examples: Amazon EC2, Microsoft Azure, Google Cloud Platform"
  caption="Real world examples: Amazon EC2, Microsoft Azure, Google Cloud Platform"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%204.webp"
  alt="Reliability Engineering Principles"
  caption="Reliability Engineering Principles"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%205.webp"
  alt="MTBF visual"
  caption="MTBF visual"
/>
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%206.webp"
  alt="Relationship between reliability and availability"
  caption="Relationship between reliability and availability"
/>
...
1. Load balancing: Distribute traffic across multiple servers to prevent single points of failure.
   ...
   <Figure
     src="/img/comparisons/2024/11/availability-vs-reliability-image%207.webp"
     alt="Load balancing across multiple servers"
     caption="Load balancing across multiple servers"
   />
...
1. Circuit Breaker Pattern: The circuit breaker pattern helps prevent cascading system failures. It operates similarly to an electrical circuit breaker, temporarily disabling failing services to avoid causing further issues across the system.
   ...
   <Figure
     src="/img/comparisons/2024/11/availability-vs-reliability-image%208.webp"
...
2. Retry Pattern: This pattern automatically retries operations that fail, enabling recovery from temporary issues without causing immediate system failure. It helps handle transient faults by re-executing failed tasks.
   ...
   <Figure
     src="/img/comparisons/2024/11/availability-vs-reliability-image%209.webp"
     alt="Retry Pattern"
     caption="Retry Pattern"
   />
...
3. Bulkhead Pattern: The bulkhead pattern isolates components to prevent failures from spreading across the system.
   ...
   <Figure
     src="/img/comparisons/2024/11/availability-vs-reliability-image%2010.webp"
     alt="Bulkhead pattern"
     caption="Bulkhead pattern"
   />
...
<Figure
  src="/img/comparisons/2024/11/availability-vs-reliability-image%2011.webp"
  alt="Netflix: Geographically Distributed Data Centers"
  caption="Netflix: Geographically Distributed Data Centers"
/>
