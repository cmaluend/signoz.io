...
authors: [daniel] # will not be found, ignored
...
keywords:
  [splunk-vs-prometheus, splunk, prometheus, opentelemetry, open-source, monitoring-tools, signoz]
---
...
<figure data-zoomable align="center">
  <img
    ...
    src="/img/blog/2024/03/splunk-vs-prometheus-cover.webp"
    alt=""
  />
</figure>
...
<figure data-zoomable align="center">
  <img
    className="box-shadowed-image"
    src="/img/blog/2024/03/splunk-vs-prometheus-monitoring.webp"
    alt="Monitoring in Splunk"
  />
  <figcaption>
    <i>Monitoring in Splunk</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img
    className="box-shadowed-image"
    src="/img/blog/2024/03/splunk-vs-prometheus-dashboards.webp"
    alt="Monitoring in Prometheus"
  />
  <figcaption>
    <i>Monitoring in Prometheus</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img
    className="box-shadowed-image"
    src="/img/blog/2024/03/splunk-vs-prometheus-data-sources.webp"
    alt="Splunk Data ingestion source"
  />
  <figcaption>
    <i>Data sources Splunk can ingest metrics from</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img
    className="box-shadowed-image"
    src="/img/blog/2024/03/splunk-vs-prometheus-browser.webp"
    alt="Prometheus expression browser"
  />
  <figcaption>
    <i>Prometheus expression browser</i>
  </figcaption>
</figure>
