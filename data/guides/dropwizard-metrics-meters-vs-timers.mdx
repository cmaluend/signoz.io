...
related_guides: ["/codahale-metrics-using-timed-metrics-annotation-in-plain-java", "/what-is-the-difference-between-a-gauge-and-a-counter"]
related_comparisons: ["/opentelemetry-vs-micrometer", "/opentelemetry-vs-cloudwatch"]
---
