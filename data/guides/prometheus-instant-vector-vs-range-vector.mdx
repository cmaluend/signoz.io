...
related_guides: ["/what-is-prometheus-for-monitoring", "/understanding-prometheus-rate-vs-increase-functions-correctly", "/what-is-the-advantage-of-prometheus"]
related_comparisons: ["/splunk-vs-prometheus"]
---
...
2. Detecting anomalies:
    ...
    <Figure src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image 7.webp" alt="" caption="" />3. Aggregating data:
