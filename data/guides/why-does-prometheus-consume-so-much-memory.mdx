...
related_guides: ["/average-memory-usage-query-prometheus", "/how-to-increase-prometheus-storage-retention", "/what-is-prometheus-for-monitoring", "/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods", "/what-are-the-limitations-of-prometheus-labels", "/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api"]
---
