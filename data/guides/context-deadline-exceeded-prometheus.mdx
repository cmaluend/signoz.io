...
related_guides: ["/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api", "/why-does-prometheus-consume-so-much-memory", "/filter-prometheus-results-by-metric-value-not-by-label-value", "/how-to-get-total-requests-in-a-period-of-time-with-prometheus", "/how-do-i-monitor-api-in-prometheus", "/what-are-the-limitations-of-prometheus-labels"]
---
...
3. Use Prometheus debug endpoints:
    ...
    - Look for goroutines stuck in scrape operations
        ...
        <Figure src="/img/guides/2024/09/context-deadline-exceeded-prometheus-image 4.webp" alt="" caption="" />Let’s decode it one by one :
