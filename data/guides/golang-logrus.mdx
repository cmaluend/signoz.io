...
<Figure src="/img/guides/2024/07/golang-logrus-Untitled 1.webp" alt="Output of all the levels" caption="Output of all the levels" />
...
<Figure src="/img/guides/2024/07/golang-logrus-Untitled 2.webp" alt="SigNoz localhost showcasing the log output of the above application." caption="SigNoz localhost showcasing the log output of the above application." />
