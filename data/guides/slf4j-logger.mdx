...
related_guides: ["/slf4j-vs-log4j", "/java-log", "/classcastexception-org-slf4j-impl-log4jloggeradapter-cannot-be-cast-to-ch-qos-logback-classic-logger", "/loggerFactory-getLogger-cannot-be-resolved-to-a-type", "/java-lang-classnotfoundexception-org-apache-logging-log4j-logger-after-updating-log4j-1-2-17-to-2-13-0"]
---
