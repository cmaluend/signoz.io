...
related_guides: ["/what-are-the-4-types-of-metrics-in-prometheus", "/how-to-handle-counters-on-servers-in-prometheus", "/what-are-prometheus-labels", "/what-is-prometheus-for-monitoring"]
---
