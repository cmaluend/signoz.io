...
related_guides: ["/kubernetes-monitoring-prometheus", "/how-to-get-number-of-pods-running-in-prometheus", "/does-kubernetes-use-prometheus", "/how-to-calculate-containers-cpu-usage-in-kubernetes-with-prometheus-as-monitoring", "/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods", "/how-to-install-prometheus-and-grafana-on-kubernetes"]
---
