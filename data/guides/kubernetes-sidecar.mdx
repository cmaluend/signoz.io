...
<Figure src="/img/guides/2026/01/kubernetes-sidecar-metrics.webp" alt="Diagram of sidecar container scraping and forwarding metrics from main application container to backend" caption="Diagram of sidecar container scraping and forwarding metrics from main application container to backend" />
...
<Figure src="/img/guides/2026/01/kubernetes-sidecar-terminal-logs.webp" alt="Sidecar demo : Stream of timestamps (dates) in terminal" caption="Sidecar demo : Stream of timestamps (dates) in terminal" />
...
<Figure src="/img/guides/2026/01/kubernetes-sidecar-job-demo.webp" alt="Sidecar-job-demo completed successfully" caption="Sidecar-job-demo completed successfully" />
...
<Figure src="/img/guides/2026/01/kubernetes-sidecar-dashboard.webp" alt="Out of the box visibility core signal provided by SigNoz" caption="Out of the box visibility core signal provided by SigNoz" />
