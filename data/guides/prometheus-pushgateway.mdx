...
<Figure src="/img/guides/2026/01/prometheus-pushgateway-workflow.webp" alt="The Batch Job pushes data once and dies. The Pushgateway holds the metric. Prometheus scrapes the Gateway later." caption="This diagram illustrates the workflow where Prometheus scrapes metrics from short-lived batch jobs via a Pushgateway intermediary." />
...
<Figure src="/img/guides/2026/01/prometheus-pushgateway-metrics-signoz.webp" alt="Metrics Flowing in from Pushgateway to SigNoz Cloud via OTel Collector" caption="Metrics Flowing in from Pushgateway to SigNoz Cloud via OTel Collector" />
...
<Figure src="/img/guides/2026/01/prometheus-pushgateway-dashboard.webp" alt="Prometheus Pushgateway dashboard consisting of end-to-end visibility into backup and ETL job health—tracking duration, size, throughput, failures, and cleanup activity via Prometheus Pushgateway metrics." caption="Prometheus Pushgateway Dashboard" />
