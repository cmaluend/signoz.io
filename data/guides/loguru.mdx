...
- Asynchronous
  ...
  - Color: Color for terminal output (Optional)
    Output
    <Figure src="/img/guides/2024/07/loguru-Untitled 1.webp" alt="The resulting output demonstrates user-defined arguments like color and name." caption="The resulting output demonstrates user-defined arguments like color and name." />
...
<Figure src="/img/guides/2024/07/loguru-Untitled 2.webp" alt="This resulting output in the console illustrates successful delivery of log records to SigNoz Cloud" caption="This resulting output in the console illustrates successful delivery of log records to SigNoz Cloud." />
...
<Figure src="/img/guides/2024/07/loguru-Untitled 3.webp" alt="The SigNoz Cloud Dashboard is displayed upon successful receipt of log records." caption="The SigNoz Cloud Dashboard is displayed upon successful receipt of log records." />
