...
<Figure src="/img/guides/2025/12/what-is-oom-physical-server.webp" alt="OS kills the process with the highest OOM score (usually the biggest memory hog)." caption="OS kills the process with the highest OOM score (usually the biggest memory hog)" />
...
<Figure src="/img/guides/2025/12/what-is-oom-k8s-node.webp" alt="Container hits configured limit, runtime kills it" caption="Container hits configured limit, runtime kills it" />
...
<Figure src="/img/guides/2025/12/what-is-oom-application-runtime.webp" alt="Application exhausts it’s own internal memory allocation" caption="Application exhausts it’s own internal memory allocation" />
...
<Figure  src="/img/guides/2025/12/what-is-oom-python-output.webp" alt="Memory getting allocated in chunks" caption="Memory getting allocated in chunks" />
...
<Figure src="/img/guides/2025/12/what-is-oom-service-name.webp" alt="The application automatically appears in the Services view once telemetry is received" caption="The application automatically appears in the Services view once telemetry is received" />
...
<Figure src="/img/guides/2025/12/what-is-oom-custom-metrics.webp" alt="Upward trend in resident memory (RSS) as the application gradually allocates memory" caption="Upward trend in resident memory (RSS) as the application gradually allocates memory" />
...
<Figure src="/img/guides/2025/12/what-is-oom-exceptions.webp" alt="MemoryError captured as an exception when the process runs out of memory" caption="MemoryError captured as an exception when the process runs out of memory" />
...
<Figure src="/img/guides/2025/12/what-is-oom-stacktrace.webp" alt="Detailed stack trace for the MemoryError exception." caption="Detailed stack trace for the MemoryError exception." />
...
<Figure src="/img/guides/2025/12/what-is-oom-traces.webp" alt="Trace graph showing the exact span where the OOM occur" caption="Trace graph showing the exact span where the OOM occur" />

From the trace, you can seamlessly pivot to logs to understand what the application was doing at that moment.

<Figure src="/img/guides/2025/12/what-is-oom-logs.webp" alt="Correlated logs view highlighting the MemoryError alongside preceding allocation logs" caption="Correlated logs view highlighting the MemoryError alongside preceding allocation logs" />
