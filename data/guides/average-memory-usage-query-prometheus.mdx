...
related_guides: ["/why-does-prometheus-consume-so-much-memory", "/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label", "/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods", "/how-to-get-total-requests-in-a-period-of-time-with-prometheus", "/how-to-increase-prometheus-storage-retention"]
---
