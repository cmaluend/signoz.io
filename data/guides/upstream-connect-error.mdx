...
<Figure src="/img/guides/2025/09/upstream-connect-error-docker-localhost-problem.webp" alt="Docker localhost problem causing upstream connect error" caption="When nginx in a container tries to connect to localhost:3000, it looks inside its own container, not at the host or other containers" />
...
<Figure src="/img/guides/2025/09/upstream-connect-error-docker-networking-correct.webp" alt="Docker networking with correct configuration" caption="Docker's internal DNS resolves container names to IP addresses for seamless inter-container communication" />
...
<Figure src="/img/guides/2025/09/upstream-connect-error-kubernetes-service-discovery.webp" alt="Kubernetes service discovery flow" caption="Kubernetes Service uses selectors to find matching Pods and create Endpoints for traffic routing" />
...
<Figure src="/img/guides/2025/09/upstream-connect-error-load-balancer-architecture.webp" alt="Load balancer architecture and health checks" caption="Cloud load balancers continuously monitor target health and only route traffic to healthy instances" />
...
<Figure src="/img/guides/2025/09/upstream-connect-error-diagnosis-decision-tree.webp" alt="Upstream error diagnosis decision tree" caption="Decision tree to quickly identify whether you're dealing with a service availability issue (502/503) or network connectivity problem (timeout)" />
...
<Figure src="/img/guides/2025/09/upstream-connect-error-istio-service-mesh-flow.webp" alt="Istio service mesh request flow" caption="Each pod's sidecar proxy intercepts all network traffic in an Istio service mesh" />
