...
<br></br>
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%201.webp" alt="Installing logrotate on Ubuntu" caption="Installinf logrotate on Ubuntu" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%202.webp" alt="Installing logrotate on CentOS" caption="Installing logrotate on CentOS" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%203.webp" alt="Checking the logrotate version" caption="Checking the logrotate version" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%205.webp" alt="Running the generate-logs script in the background" caption="Running the generate-logs script in the background" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%206.webp" alt="Watch the log directory to get the list of  file generated by logrotate" caption="Watch the log directory to get the list of  file generated by logrotate" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%207.webp" alt="Installing OpenTelemetry collector" caption="Installing OpenTelemetry collector" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%208.webp" alt="Exploring logs in the SigNoz Dashboard" caption="Exploring logs in the SigNoz Dashboard" />
<br></br>- You can filter logs on various parameters , for example if body contains “Error”

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%209.webp" alt="Filtering logs in SigNoz Logs Explorer" caption="Filtering logs in SigNoz Logs Explorer" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2010.webp" alt="Setting up conditions for SigNoz alerts" caption="Setting up conditions for SigNoz alerts" />
<br></br>- Threshold: 1 occurrence within the last 60 minutes.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2011.webp" alt="Configuring threshold for SigNoz alerts" caption="Configuring threshold for SigNoz alerts" />
<br></br>- Action: Send an email or trigger a webhook.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2012.webp" alt="Configuring notification channel for SigNoz alerts" caption="Configuring notification channel for SigNoz alerts" />
<br></br>
