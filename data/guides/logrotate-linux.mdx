...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled.webp" alt="Updating package lists" caption="Updating package lists" />
<br></br>
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 1.webp" alt="Installing logrotate on Ubuntu" caption="Installinf logrotate on Ubuntu" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 2.webp" alt="Installing logrotate on CentOS" caption="Installing logrotate on CentOS" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 3.webp" alt="Checking the logrotate version" caption="Checking the logrotate version" />
<br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 4.webp" alt="`logrotate` Global Configuration file" caption="`logrotate` Global Configuration file" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 5.webp" alt="Running the generate-logs script in the background" caption="Running the generate-logs script in the background" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 6.webp" alt="Watch the log directory to get the list of  file generated by logrotate" caption="Watch the log directory to get the list of  file generated by logrotate" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 7.webp" alt="Installing OpenTelemetry collector" caption="Installing OpenTelemetry collector" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 8.webp" alt="Exploring logs in the SigNoz Dashboard" caption="Exploring logs in the SigNoz Dashboard" />
<br></br>- You can filter logs on various parameters , for example if body contains “Error”

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 9.webp" alt="Filtering logs in SigNoz Logs Explorer" caption="Filtering logs in SigNoz Logs Explorer" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 10.webp" alt="Setting up conditions for SigNoz alerts" caption="Setting up conditions for SigNoz alerts" />
<br></br>- Threshold: 1 occurrence within the last 60 minutes.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 11.webp" alt="Configuring threshold for SigNoz alerts" caption="Configuring threshold for SigNoz alerts" />
<br></br>- Action: Send an email or trigger a webhook.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled 12.webp" alt="Configuring notification channel for SigNoz alerts" caption="Configuring notification channel for SigNoz alerts" />
<br></br>
