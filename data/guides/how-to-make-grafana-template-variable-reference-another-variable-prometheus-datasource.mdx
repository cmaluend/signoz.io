...
related_guides: ["/how-does-grafana-get-data-from-prometheus", "/how-to-see-prometheus-metrics-in-grafana", "/how-to-install-prometheus-and-grafana-on-docker", "/how-to-set-dashboards-on-grafana-home-page", "/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label"]
