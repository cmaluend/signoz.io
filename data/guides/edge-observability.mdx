...
<Figure src="/img/guides/2024/11/edge-observability-image 1.webp" alt="Distributed edge locations for Edge Observability Monitoring" caption="Distributed edge locations for Edge Observability Monitoring" />
...
<Figure src="/img/guides/2024/11/edge-observability-image 2.webp" alt="Steps to implement edge observability" caption="Steps to implement edge observability" />
...
<Figure src="/img/unified-observability/unified-observability-metrics-and-dashboards.webp" alt="metrics and dashboards" caption="metrics and dashboards" />
