...
<Figure src="/img/guides/2025/12/prometheus-node-exporte-custom-collector.webp" alt="Custom Node Exporter metric exposed via textfile collector" caption="Custom Node Exporter metric exposed via textfile collector" />
...
<Figure src="/img/guides/2025/12/prometheus-node-exporter-rules.webp" alt="Prometheus Rule Health view showing Node Exporter alerting rules loaded successfully" caption="Prometheus Rule Health view showing Node Exporter alerting rules loaded successfully" />

**Active alerts page:** `/alerts`

<Figure src="/img/guides/2025/12/prometheus-node-exporter-alerts.webp" alt="Prometheus Alerts view showing Node Exporter alerting rules loaded and currently inactive" caption="Prometheus Alerts view showing Node Exporter alerting rules loaded and currently inactive" />

**Scrape the target's page:** `/targets`

<Figure src="/img/guides/2025/12/prometheus-node-exporter-targets.webp" alt="Prometheus Target Health view confirming the Node Exporter scrape target" caption="Prometheus Target Health view confirming the Node Exporter scrape target" />
