...
related_guides: ["/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods", "/how-to-monitor-custom-kubernetes-pod-metrics-using-prometheus", "/kubernetes-monitoring-prometheus", "/how-to-get-number-of-pods-running-in-prometheus", "/does-kubernetes-use-prometheus", "/how-to-install-prometheus-and-grafana-on-kubernetes"]
---
