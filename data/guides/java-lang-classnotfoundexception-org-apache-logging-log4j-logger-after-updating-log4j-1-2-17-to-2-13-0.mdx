...
related_guides: ["/caused-by-java-lang-noclassdeffounderror-org-apache-log4j-logger", "/loggerFactory-getLogger-cannot-be-resolved-to-a-type", "/classcastexception-org-slf4j-impl-log4jloggeradapter-cannot-be-cast-to-ch-qos-logback-classic-logger", "/slf4j-logger", "/slf4j-vs-log4j", "/java-log"]
---
