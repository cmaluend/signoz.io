...
1. Using the Start Menu:
   ...
   <br></br>
   <Figure src="/img/guides/2024/07/windows-logs-Untitled 1.webp" alt="Windows Event viewer landing page" caption="Windows Event viewer landing page" />
   ...
   <Figure src="/img/guides/2024/07/windows-logs-Untitled 2.webp" alt="CMD terminal" caption="CMD terminal" />
   <br></br>
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled 3.webp" alt="Windows Event Viewer logs" caption="Windows Event Viewer logs" />
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled 4.webp" alt="Severity levels for events" caption="Severity levels for events" />
<br></br>
<Figure src="/img/guides/2024/07/windows-logs-Untitled 5.webp" alt="System Event logs page" caption="System Event logs page" />
<br></br>
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled 6.webp" alt="Opening Administrative events" caption="Opening Administrative events" />
<br></br>
<Figure src="/img/guides/2024/07/windows-logs-Untitled 7.webp" alt="Custom View page from Admin Events" caption="Custom View page from Admin Events" />
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled 8.webp" alt="Selecting Event Levels" caption="Selecting Event Levels" />
<br></br>1. Once done, choose how you want the events to be filtered, `By log` or `By source`.

<Figure src="/img/guides/2024/07/windows-logs-Untitled 9.webp" alt="Filtering using: By log" caption="Filtering using: By log" />
<br></br>
<Figure src="/img/guides/2024/07/windows-logs-Untitled 10.webp" alt="Filtering using: By Source" caption="Filtering using: By Source" />
