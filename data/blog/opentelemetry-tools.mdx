...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/traces-view.webpon_metrics.webp" alt="An OpenTelemetry backend built natively for OpenTelemetry, SigNoz provides out-of-box charts for application metrics"/>
