...
The interactive below shows the same 40 users. Try grouping them different ways and watch how the number of groups changes.
...
If you organize files by **region**, you have 4 drawers: US-East, US-West, EU, and APAC. Finding a file is easy—open the right drawer, grab the file. The database can do this quickly because there are only 4 places to look.
...
A metric is not just "CPU usage." A metric is CPU usage *with labels attached*.
