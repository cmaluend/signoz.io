...
Detailed /img/docs/apm-and-distributed-tracing/traces-view.webpact cause of the issue and which underlying requests are causing the problem. Is it a SQL query gone rogue or a Redis operation is causing an issue? Get more context on your spans with tags and events.
