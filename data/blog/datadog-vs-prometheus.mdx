...
You can a/img/docs/apm-and-distributed-tracing/traces-view.webpblog/flamegraphs/) to visualize spans from your trace data. All of this comes out of the box with SigNoz.
