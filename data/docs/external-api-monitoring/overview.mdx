...
For more information about `kind_string` values and usage, refer to the [ClickHouse traces query documentation](https://signoz.io/docs/userguide/writing-clickhouse-traces-query/) and the [OpenTelemetry span specifications](https://opentelemetry.io/docs/specs/otel/trace/api/#spankind).
