---
date: 2025-09-01
id: switch-from-opentelemetry-to-signoz
title: Switch from existing OpenTelemetry
description: Switching from OpenTelemetry to SigNoz. How to switch metrics, traces, and logs from OpenTelemetry to SigNoz.
---
...
- **[Switch to SigNoz Cloud](https://signoz.io/docs/switch-to-signoz/switch-from-opentelemetry/cloud/)** - is the fastest way to get started. It's a fully managed service available in multiple regions with built-in high availability - you just need an ingestion key to start sending data.
- **[switch to Self-Hosted SigNoz](https://signoz.io/docs/switch-to-signoz/switch-from-opentelemetry/self-hosted/)** - gives you complete control over your observability infrastructure. Deploy it on your own servers or cloud with customizable configuration and no external dependencies.
