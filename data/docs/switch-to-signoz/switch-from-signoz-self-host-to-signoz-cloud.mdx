---
date: 2025-03-27
id: switch-from-signoz-self-host-to-signoz-cloud
title: Switch from Self-Hosted SigNoz to SigNoz Cloud
description: Process about how to switch from Self-Hosted SigNoz to SigNoz Cloud
---

## Why Switch to SigNoz Cloud?

Switching to SigNoz Cloud offers a range of benefits that enhance your monitoring and observability experience:
...
## Steps to Switch from Self-Hosted SigNoz to SigNoz Cloud
...
## Switch Dashboards & Metadata

Regardless of your setup, you'll need to switch your dashboards and configurations:
...
- Verify all dashboards and metadata have been switched correctly by checking your cloud tenant.
