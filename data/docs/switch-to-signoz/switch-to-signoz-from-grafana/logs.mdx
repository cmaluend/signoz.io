---
date: 2025-04-22
id: switch-from-grafana-logs
title: Switch Logs from LGTM Stack
description: Switching logs from LGTM Stack to SigNoz. How to switch logs from LGTM Stack to SigNoz.
---

To switch logs from Loki to SigNoz, you'll need to reconfigure your log collection agents to send data to  OpenTelemetry collectors.
