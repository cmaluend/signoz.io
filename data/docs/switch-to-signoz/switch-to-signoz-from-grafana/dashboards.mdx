---
date: 2025-04-22
id: switch-from-grafana-dashboards
title: Switch Dashboards from LGTM Stack
description: Switching dashboards from LGTM Stack to SigNoz. How to switch dashboards from LGTM Stack to SigNoz.
---
...
1. Find the dashboard you want to switch in [SigNoz Dashboard Templates repository](https://github.com/SigNoz/dashboards)
