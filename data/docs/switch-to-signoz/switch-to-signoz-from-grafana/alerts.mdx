---
date: 2025-04-22
id: switch-from-grafana-alerts
title: Switch Alerts from LGTM Stack
description: Switching alerts from LGTM Stack to SigNoz. How to switch alerts from LGTM Stack to SigNoz.
---

While switching your observability stack from the LGTM stack to SigNoz, you'll also need to recreate your alerts in SigNoz's alert management system.

### Setting Up Notification Channels

Before switching your alerts to SigNoz, you will need to set up the notification channels you want to use. Below is a list of notification channels supported by AlertManager/Grafana and SigNoz:
...
In case you define alert rules as code in your LGTM Stack (either as Prometheus rules or using Grafana Terraform provider), you can continue using the same approach while switching to SigNoz, by utilizing the [SigNoz Terraform Provider](https://signoz.io/docs/alerts-management/terraform-provider-signoz/).
