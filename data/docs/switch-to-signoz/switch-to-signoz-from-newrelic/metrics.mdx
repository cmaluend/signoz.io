...
date: 2025-05-12
id: metrics
title: Switch Metrics from New Relic
description: Switching metrics from New Relic to SigNoz. How to switch metrics from New Relic to SigNoz.
---

Switching metrics from New Relic to SigNoz involves reconfiguring your metrics collection to work with OpenTelemetry. This guide provides several approaches depending on your current setup.

## Understanding Metric Collection Differences

Before switching, it's important to understand the key differences between New Relic and SigNoz metrics:
...
| **Query Language**      | NRQL                                   | PromQL, ClickHouse SQL                  | Switching requires query translation                  |
| **Storage**             | NRDB                                   | ClickHouse                              | Different backend storage technology                  |

## Switching Approaches

SigNoz offers multiple ways to switch your metrics from New Relic. Choose the approach that best fits your infrastructure and requirements.
...
### 4. Switch Infrastructure Metrics
...
### 5. Switching Cloud Infrastructure Integrations

If you were using New Relic to monitor cloud infrastructure (AWS, Azure, GCP), SigNoz provides [native integrations)(/docs/cloud/) to help you switch your cloud monitoring setup.
...
### 6. Switching Synthetics/Availability Monitoring
...
To switch basic uptime and HTTP check monitoring from New Relic Synthetics to SigNoz, you can use the built-in HTTP endpoint monitoring feature. This enables you to set up periodic checks for your endpoints and receive alerts if they become unavailable or respond slowly.
...
When switching from New Relic to SigNoz, you'll need to map New Relic metric names to their OpenTelemetry equivalents. Here are some common mappings:
...
After switching your metrics collection to SigNoz, it's important to verify that everything is working correctly:
...
Once your metrics are successfully switched to SigNoz, consider:

- [Creating dashboards](/docs/switch-to-signoz/switch-from-newrelic/dashboards) for your most important metrics
- [Setting up alerts](/docs/switch-to-signoz/switch-from-newrelic/alerts) based on these metrics
- [Switching your traces](/docs/switch-to-signoz/switch-from-newrelic/traces) for end-to-end observability
- [Switching your logs](/docs/switch-to-signoz/switch-from-newrelic/logs) to complete your observability stack
