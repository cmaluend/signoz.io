...
date: 2025-05-12
id: logs
title: Switch Logs from New Relic
description: Switching logs from New Relic to SigNoz. How to switch logs from New Relic to SigNoz.
---

Switching logs from New Relic to SigNoz involves reconfiguring your log collection pipeline to send data to SigNoz instead. This guide covers different approaches based on your current setup.

## Understanding Log Collection Differences

Before switching, it's important to understand the key differences between New Relic and SigNoz logs:
...
### 3. Switching from New Relic APM Agent Log Forwarding
...
If you're switching logs from New Relic APM agents, you may have logs in this format:
...
Once your logs are successfully switching to SigNoz, consider:

- [Creating dashboards](/docs/switch-to-signoz/switch-from-newrelic/dashboards) with log-based panels
