...
date: 2025-05-12
id: traces
title: Switch Traces from New Relic
description: Switching traces from New Relic to SigNoz. How to switch APM traces from New Relic to SigNoz.
---

Switching distributed tracing from New Relic to SigNoz involves replacing New Relic APM agents with OpenTelemetry instrumentation. This guide will walk you through the process for different scenarios.

## Understanding Trace Collection Differences

Before switching, it's important to understand the key differences between New Relic and SigNoz tracing:
...
The approach for switching traces depends on how you're currently collecting traces in New Relic.
...
#### Example: Switching from New Relic Java Agent to OpenTelemetry
...
When switching from New Relic to SigNoz, you'll need to map [New Relic's span attributes](https://docs.newrelic.com/attribute-dictionary/) to [OpenTelemetry's semantic conventions](https://opentelemetry.io/docs/specs/semconv/general/trace/). Here are some common mappings:
...
## Verifying Trace Switching

After switching your instrumentation, verify that traces are being received correctly:
...
Compare key metrics between New Relic and SigNoz during the switching period to ensure data consistency.

## Next Steps

Once your traces are successfully switching to SigNoz, consider:

- [Creating dashboards](/docs/switch-to-signoz/switch-from-newrelic/dashboards) with trace-based panels
