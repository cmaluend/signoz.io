...
date: 2025-05-12
id: dashboards
title: Switch Dashboards from New Relic
description: Switching dashboards from New Relic to SigNoz. How to switch dashboards from New Relic to SigNoz.
---
...
When switching complex New Relic dashboards, it's helpful to:
...
Once your dashboards are successfully switched to SigNoz, consider:

- [Switching additional metrics](/docs/switch-to-signoz/switch-from-newrelic/metrics) for your dashboards
