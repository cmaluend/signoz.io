---
date: 2024-10-03
id: switch-from-datadog-to-signoz
title: Switch From Datadog
description: Switching from Datadog to SigNoz. How to switch metrics, traces, and logs from Datadog to SigNoz.
---

SigNoz provides a unified OpenTelemetry native solution for monitoring metrics, traces, and logs, allowing for greater flexibility and control over your data. This guide will walk you through the steps to switch your existing Datadog setup to SigNoz, covering all essential signals: metrics, traces, and logs.
...
To switch your logging setup, you need to configure appropriate log receivers and set up parsing pipelines in SigNoz.
