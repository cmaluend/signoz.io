...
date: 2025-05-06
id: logs
title: Switch logs from ELK Stack
description: Switching logs from ELK Stack to SigNoz. How to switch logs from ELK to SigNoz.
---

Switching logs involves replacing [Filebeat](https://www.elastic.co/beats/filebeat) and/or [Logstash](https://www.elastic.co/logstash) with the [OpenTelemetry](https://signoz.io/why-opentelemetry/) (OTel) Collector, configured to collect, process, and forward logs to SigNoz.
