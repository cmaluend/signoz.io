...
date: 2025-05-06
id: dashboards
title: Switch dashboards from ELK Stack
description: Switching dashboards from ELK Stack to SigNoz. How to switch dashboards from ELK to SigNoz.
---

Switching dashboards from [Kibana](https://github.com/elastic/kibana) to SigNoz requires manual recreation due to fundamental differences in the underlying data storage, query languages, and dashboard schemas.There is no direct import mechanism for Kibana dashboards into SigNoz.
