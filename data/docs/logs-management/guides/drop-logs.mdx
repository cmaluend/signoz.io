...
For more information about the [transform processor](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/configuration/#transform-processor) and the `truncate_all` function, refer to the SigNoz documentation.
