...
export OTEL_METRIC_EXPORT_INTERVAL="<export-interval>"
```
...
$env:OTEL_METRIC_EXPORT_INTERVAL = "<export-interval>"
```
Replace the following:
...
docker run -e OTEL_EXPORTER_OTLP_ENDPOINT="https://ingest.<region>.signoz.cloud:443" \
    ...
    -e OTEL_METRIC_EXPORT_INTERVAL="<export-interval>" \
    your-image:latest
```
