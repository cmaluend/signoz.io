...
There's a `setup.sh` script in the [Pack directory](https://github.com/hashicorp/nomad-pack-community-registry/blob/main/packs/signoz/setup.sh) that can automatically
...
changes. If you prefer to run the same steps manually, follow the sequence
below.
