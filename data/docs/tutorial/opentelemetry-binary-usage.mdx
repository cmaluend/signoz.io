...
<figure data-zoomable align="center">
  ...
  <figcaption>
    <i>
      OpenTelemetry-instrumented applications in a VM can send data to otel-binary which then sends
      data to SigNoz cloud.
    </i>
  </figcaption>
</figure>
...
<Admonition type="info">
  In the case of different OpenTelemetry collector versions, replace `0.116.0` with the respective
  version.
</Admonition>
...
Replace `<IP of machine hosting SigNoz>` with the address to SigNoz in the `exporters` section.
