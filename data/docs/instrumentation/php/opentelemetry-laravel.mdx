---
date: 2026-01-18
id: opentelemetry-laravel
title: Laravel OpenTelemetry Instrumentation
description: Learn how to instrument your Laravel application with OpenTelemetry and send traces to SigNoz.
doc_type: howto
---

This guide shows you how to instrument your Laravel application with OpenTelemetry and send traces to SigNoz. The auto-instrumentation approach automatically captures HTTP requests, database queries, and other Laravel operations.
...
- `<service-name>`: A descriptive name for your service (e.g., `laravel-api`).
...
1. Trigger some actions in your Laravel app (visit pages, submit forms, make API calls).
...
```bash
OTEL_TRACES_EXPORTER=console php artisan serve
```
...
- [Set up alerts](https://signoz.io/docs/setup-alerts-notification/) for your Laravel application
