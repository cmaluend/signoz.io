...
- OpenTelemetry SDK installed via [Composer](https://getcomposer.org/):
  ...
  ```
- Environment variables configured to export traces (see [PHP instrumentation guide](https://signoz.io/docs/instrumentation/php/opentelemetry-php/) for details).
