...
- Finish the core Python setup in the [OpenTelemetry Python instrumentation guide](https://signoz.io/docs/instrumentation/opentelemetry-python/overview/) so exporters, tracer provider, and propagators are configured.
...
- Return to the [Python instrumentation overview](https://signoz.io/docs/instrumentation/opentelemetry-python/overview/) for framework-specific guides
