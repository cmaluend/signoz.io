...
- Node.js version 18.0 or higher (see official list of [supported versions](https://github.com/open-telemetry/opentelemetry-js/blob/main/README.md#supported-runtimes))
