...
<Admonition type="note">
  To use this dashboard, ensure you are collecting Kubernetes volume metrics. [Learn how to configure Kubernetes metrics collection](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/configure-k8s-infra/#4-kubernetes-metrics-collection).
</Admonition>
