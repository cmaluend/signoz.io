...
We've published a complete example application at <a href="https://github.com/SigNoz/temporal-typescript-opentelemetry" target="_blank" rel="noopener noreferrer nofollow">github.com/SigNoz/temporal-typescript-opentelemetry</a>. Follow along with the code as you work through this guide.
...
└─────────────────┘  │
                     │ Telemetry
┌─────────────────┐  │  ┌──────────────┐
│ Temporal Worker │──┼─→│ OpenTelemetry│──→ SigNoz
│ (runs workflow) │  │  │     SDK      │
└─────────────────┘  │  └──────────────┘
                     │
┌─────────────────┐  │
