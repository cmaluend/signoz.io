...
4. Set your desired interval (e.g., Every 30 Minutes)
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/repeat-notification.png" alt="Repeat notification configuration"/>
    <figcaption><i>Configuring repeat notifications for alerts</i></figcaption>
</figure>
